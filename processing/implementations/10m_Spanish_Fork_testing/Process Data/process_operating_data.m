...
cal = in.cal;
%% Assign data folder
dataDir = 'X:\Experiments and Data\20 kW Prototype\Loads_Data\operating_uncompressed';
opts.resample.taskName = 'rotor_strain';
opts.resample.rate = 400;

td = processDataFolder2(dataDir,cal,opts);
%% Load constants
...
%     if consts.debugMode
%         save_name = fullfile(save_dir,sprintf('DEBUG_operating_results_%d.mat',data_filename_timestamps(II)));
%     else
