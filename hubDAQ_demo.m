...
pause(5)
d.logging.fileNamePrefix = 'hubDaqTest';
...
d.task(1).addChannel('AIBridge','cDAQ9188-18F21FFMod3','ai0','LowerArm Mz','mV per Volt',[-25 25],'full','external',9.7,350);
...
%% Votlage channels
d.createTask('AI','hubVoltages',64,1);

d.task(2).addChannel('AIVoltage','cDAQ9188-18F21FFMod6','ai17','Battery Voltage','RSE',[-10 10]);
...
% d.task(2).setSampClkTimebaseSrc('/cDAQ9188-18F21FF/PFI0'); 
% d.task(2).setSampClkTimebaseRate(sampleClockTimebaseRate);
